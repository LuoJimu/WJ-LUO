...
import com.evan.sanhei.common.realm.WJRealm;
...
//手动导入解决Error:(29, 51) java: 不兼容的类型: java.lang.SecurityManager无法转换为org.apache.shiro.mgt.SecurityManager报错

/**
 * @program: WJ-LUO
 * @description:  Shiro 的配置类
 * @author: Jimu.Luo
 * @create: 2021-09-17 21:51
 **/
